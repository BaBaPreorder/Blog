...
<BaseLayout title="Home">
  <BaseCard title="Home" image="/dark_sky_wallpaper_1920x600.png">
    <div class="flex">
      <div class="p-6">
          # Hello everyone !!! 👋
...
My name is Pattarapong Ramungthong, AKA **Mirthz**. CTF Player from Thailand 🇹🇭  
Now, I'm Cybersecurity Graduated Student (Master's degree) in USA 🇺🇸

**Thank you for everyone, who come to visit this blog. 🙏🙏**

## CTF-Player
<iframe src="https://tryhackme.com/api/v2/badges/public-profile?userPublicId=6493" style='border:none;'></iframe>


## Cybersecurity Graduated Student
**University**
Now (2024), I started study in Master's degree in Information Assurance and Cybersecurity at [Gannon University](https://www.gannon.edu)
{/* ### 🧊 Frosti
